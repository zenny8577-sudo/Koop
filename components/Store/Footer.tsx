...
const Footer: React.FC<FooterProps> = ({ onNavigate }) => {
  ...
  return (
    <footer className="bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-white/5 pt-24 pb-12 transition-colors duration-300">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-24">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <p className="text-slate-500 dark:text-slate-400 font-medium leading-relaxed max-w-sm text-base">
          ...
          <div className="lg:col-span-2 lg:ml-auto space-y-8">
            <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 dark:text-slate-500">Shop</h4>
            <ul className="space-y-4">
              <li><button onClick={() => onNavigate('shop')} className="text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-[#FF4F00] dark:hover:text-[#FF4F00] transition-colors uppercase tracking-widest">Collectie</button></li>
              <li><button onClick={() => onNavigate('sell')} className="text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-[#FF4F00] dark:hover:text-[#FF4F00] transition-colors uppercase tracking-widest">Verkopen</button></li>
              <li><button onClick={() => onNavigate('shop')} className="text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-[#FF4F00] dark:hover:text-[#FF4F00] transition-colors uppercase tracking-widest">Nieuw Binnen</button></li>
            </ul>
          </div>

          <div className="lg:col-span-2 space-y-8">
            <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 dark:text-slate-500">Support</h4>
            <ul className="space-y-4">
              <li><button onClick={() => onNavigate('about')} className="text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-[#FF4F00] dark:hover:text-[#FF4F00] transition-colors uppercase tracking-widest">Over Koop</button></li>
              <li><button onClick={() => onNavigate('faq')} className="text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-[#FF4F00] dark:hover:text-[#FF4F00] transition-colors uppercase tracking-widest">FAQ</button></li>
              <li><button onClick={() => onNavigate('contact')} className="text-xs font-bold text-slate-600 dark:text-slate-300 hover:text-[#FF4F00] dark:hover:text-[#FF4F00] transition-colors uppercase tracking-widest">Contact</button></li>
            </ul>
          </div>

          <div className="lg:col-span-4 space-y-8">
            <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400 dark:text-slate-500">Betaal Veilig</h4>
            ...
            <div className="p-6 bg-slate-50 dark:bg-white/5 rounded-3xl border border-slate-100 dark:border-white/5">
               <p className="text-[9px] font-black uppercase tracking-[0.2em] text-slate-400 dark:text-slate-500 leading-relaxed">
        ...
        <div className="pt-10 border-t border-slate-100 dark:border-white/5 flex flex-col md:flex-row justify-between items-center gap-10">
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            >
              ...
              <span className="text-[9px] font-black uppercase tracking-[0.15em] text-slate-400 dark:text-slate-300 group-hover:text-white dark:group-hover:text-slate-900 transition-colors">
