...
const Navbar: React.FC<NavbarProps> = ({ 
  ...
  return (
    <nav className="sticky top-0 z-[100] bg-white/70 backdrop-blur-2xl border-b border-slate-100/50 transition-colors duration-300">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 h-24 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <button 
            onClick={onWishlist}
            className="p-2 text-slate-900 hover:text-[#FF4F00] transition-colors"
            title="Favorieten"
          >
