    ...
    <div className="space-y-24 lg:space-y-40 pb-20 lg:pb-60 animate-fadeIn overflow-hidden">
      ...
      <section className="relative min-h-[85vh] lg:h-[95vh] flex flex-col justify-center px-6 lg:px-24 mx-2 lg:mx-12 rounded-[40px] lg:rounded-[120px] overflow-hidden bg-black mt-2 lg:mt-8 group border border-transparent dark:border-white/10 py-12 lg:py-0">
        ...
        <div className="relative z-10 max-w-5xl space-y-6 lg:space-y-14">
          <div className="space-y-3 lg:space-y-4">
            <span className="inline-block px-3 py-1.5 lg:px-5 lg:py-2.5 bg-[#FF4F00]/10 text-[#FF4F00] text-[8px] lg:text-[11px] font-black uppercase tracking-[0.2em] lg:tracking-[0.4em] rounded-full border border-[#FF4F00]/20 backdrop-blur-md whitespace-nowrap">{t('hero_badge')}</span>
            <h1 className="text-4xl sm:text-5xl lg:text-[160px] font-black text-white leading-[0.9] lg:leading-[0.8] tracking-tighter uppercase break-words">
              {t('hero_title_1')} <br /> <span className="text-[#FF4F00]">{t('hero_title_2')}</span>
            </h1>
          </div>
          <p className="text-white/60 text-sm lg:text-2xl font-medium max-w-2xl leading-relaxed pr-4 lg:pr-0">{t('hero_desc')}</p>
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-8 pt-4 lg:pt-6 w-full sm:w-auto">
            <button onClick={() => onNavigate('shop')} className="w-full sm:w-auto px-6 py-4 lg:px-16 lg:py-8 bg-[#FF4F00] text-white font-black text-[10px] lg:text-xs uppercase tracking-[0.3em] rounded-2xl lg:rounded-[32px] hover:bg-white hover:text-black transition-all transform hover:-translate-y-2 shadow-2xl shadow-orange-500/20">{t('hero_cta_shop')}</button>
            <button onClick={() => onNavigate('sell')} className="w-full sm:w-auto px-6 py-4 lg:px-16 lg:py-8 bg-white/5 backdrop-blur-xl text-white border border-white/10 font-black text-[10px] lg:text-xs uppercase tracking-[0.3em] rounded-2xl lg:rounded-[32px] hover:bg-white/10 transition-all">{t('hero_cta_sell')}</button>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 lg:mb-12 gap-6">
          <div className="space-y-2">
            <span className="text-[9px] lg:text-[10px] font-black uppercase tracking-[0.4em] text-[#FF4F00]">{t('home_new_badge')}</span>
            <h2 className="text-3xl lg:text-6xl font-black text-slate-900 dark:text-white tracking-tighter uppercase">{t('home_new_title')}<span className="text-[#FF4F00]">.</span></h2>
          </div>
          <button onClick={() => onNavigate('shop')} className="text-[10px] lg:text-[11px] font-black uppercase tracking-widest text-slate-400 dark:text-neutral-500 hover:text-[#FF4F00] transition-colors border-b-2 border-slate-100 dark:border-white/10 hover:border-[#FF4F00] pb-2">{t('home_view_all')}</button>
        </div>
      ...
      <section className="px-6 lg:px-12">
        <div className="max-w-[1440px] mx-auto space-y-8 lg:space-y-12">
           <div className="flex justify-between items-end">
              <div className="space-y-2">
                <span className="text-[9px] lg:text-[10px] font-black uppercase tracking-[0.4em] text-[#FF4F00]">{t('home_spotlight_badge')}</span>
                <h2 className="text-3xl lg:text-6xl font-black text-slate-900 dark:text-white tracking-tighter uppercase">{t('home_spotlight_title')}<span className="text-[#FF4F00]">.</span></h2>
              </div>
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-12 lg:mb-20">
          <div className="space-y-4">
            <span className="text-[9px] lg:text-[10px] font-black uppercase tracking-[0.4em] text-[#FF4F00]">{t('home_cats_badge')}</span>
            <h2 className="text-4xl lg:text-8xl font-black text-slate-900 dark:text-white tracking-tighter uppercase leading-none">{t('home_cats_title')}<span className="text-[#FF4F00]">.</span></h2>
          </div>
          <p className="text-slate-500 dark:text-neutral-400 font-medium max-w-sm text-sm lg:text-lg leading-relaxed">{t('home_cats_desc')}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 lg:gap-6 h-auto md:h-[1000px] lg:h-[800px]">
          ...
          <div className="h-[300px] md:h-auto md:col-span-8 group relative overflow-hidden rounded-[40px] lg:rounded-[60px] cursor-pointer border border-transparent dark:border-white/5" onClick={() => { onNavigate('shop'); }}>
            ...
            <div className="absolute bottom-8 left-8 lg:bottom-12 lg:left-12 space-y-2">
              ...
              <h4 className="text-3xl lg:text-5xl font-black text-white uppercase tracking-tighter">{t('cat_electronics')}</h4>
            </div>
          </div>
          ...
          <div className="h-[300px] md:h-auto md:col-span-4 group relative overflow-hidden rounded-[40px] lg:rounded-[60px] cursor-pointer border border-transparent dark:border-white/5" onClick={() => { onNavigate('shop'); }}>
            ...
            <div className="absolute bottom-8 left-8 lg:bottom-12 lg:left-12 space-y-2">
              ...
              <h4 className="text-3xl lg:text-5xl font-black text-white uppercase tracking-tighter">{t('cat_design')}</h4>
            </div>
          </div>
          ...
          <div className="h-[250px] md:h-auto md:col-span-4 group relative overflow-hidden rounded-[40px] lg:rounded-[60px] cursor-pointer border border-transparent dark:border-white/5" onClick={() => { onNavigate('shop'); }}>
            ...
            <div className="absolute bottom-8 left-8 lg:bottom-12 lg:left-12 space-y-2">
              ...
              <h4 className="text-3xl lg:text-5xl font-black text-white uppercase tracking-tighter">{t('cat_bikes')}</h4>
            </div>
          </div>
          ...
          <div className="h-[250px] md:h-auto md:col-span-4 group relative overflow-hidden rounded-[40px] lg:rounded-[60px] cursor-pointer border border-transparent dark:border-white/5" onClick={() => { onNavigate('shop'); }}>
            ...
            <div className="absolute bottom-8 left-8 lg:bottom-12 lg:left-12 space-y-2">
              ...
              <h4 className="text-3xl lg:text-5xl font-black text-white uppercase tracking-tighter">{t('cat_antique')}</h4>
            </div>
          </div>
          ...
          <div className="h-[200px] md:h-auto md:col-span-4 group relative overflow-hidden rounded-[40px] lg:rounded-[60px] cursor-pointer bg-slate-950 flex items-center justify-center border border-white/5" onClick={() => { onNavigate('shop'); }}>
             ...
             <div className="relative z-10 text-center space-y-4">
               <h4 className="text-3xl lg:text-4xl font-black text-white uppercase tracking-tighter group-hover:text-[#FF4F00] transition-colors">{t('cat_gadgets')}</h4>
               <p className="text-[9px] lg:text-[10px] font-black text-white/40 uppercase tracking-[0.4em]">{t('home_view_all')}</p>
             </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-[1440px] mx-auto px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {[
            { title: t('trust_verified_title'), desc: t('trust_verified_desc'), icon: '🛡️' },
            { title: t('trust_shipping_title'), desc: t('trust_shipping_desc'), icon: '🚚' },
            { title: t('trust_payment_title'), desc: t('trust_payment_desc'), icon: '💳' }
          ].map((item, i) => (
      ...
      <section className="px-6 lg:px-12 pb-20 lg:pb-40">
        <div className="max-w-[1440px] mx-auto bg-[#FF4F00] rounded-[60px] lg:rounded-[80px] p-12 lg:p-32 flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16 overflow-hidden relative group">
          ...
          <div className="relative z-10 max-w-2xl space-y-6 lg:space-y-8 text-center lg:text-left">
            <h2 className="text-4xl lg:text-8xl font-[900] text-white tracking-tighter uppercase leading-[0.9] lg:leading-[0.85]">{t('cta_title_1')} <br /> {t('cta_title_2')}</h2>
            <p className="text-white/80 text-lg lg:text-xl font-medium">{t('cta_desc')}</p>
          </div>
          <div className="relative z-10">
            <button onClick={() => onNavigate('sell')} className="px-12 lg:px-20 py-6 lg:py-10 bg-black text-white font-black text-xs lg:text-sm uppercase tracking-[0.3em] lg:tracking-[0.4em] rounded-full hover:bg-white hover:text-[#FF4F00] transition-all transform hover:scale-110 shadow-3xl">{t('cta_button')}</button>
          </div>
        </div>
      </section>
    </div>
